...
def material_weight_calculator(request):
    ...
    param = {"link_string1": link_string1, "link_string2": link_string2}
    return render(
        request, "../templates/calculator/material_weight_calculator.html", param
    )
...
def Linear_regression_calculator(request):
            ...
            response = json.dumps(
                {
                    ...
                    "Σy^2": y2,
                    "Σxy": xy,
                    "Linear Regression Equation(bx + a)": eqn,
                },
                default=str,
            )
    ...
    return render(
        request, "../templates/calculator/linear_regression_calculator.html", param
    )
...
def SWP_calculator(request):
    link_string1, link_string2 = SideMap.arrange(9, 4, "CC")
    param = {"link_string1": link_string1, "link_string2": link_string2}
    return render(request, "../templates/calculator/SWP_calculator.html", param)
